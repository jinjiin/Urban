...
from UrbanModels.lstm_raw.logger import setup_logging
from UrbanModels.lstm_raw.utils import read_json, write_json
...
class ConfigParser:
    def __init__(self, args, options='', timestamp=True):
        ...
        args.device = 0
        args.resume = None
        args.config = './UrbanModels/lstm_raw/config_pm25.json'
