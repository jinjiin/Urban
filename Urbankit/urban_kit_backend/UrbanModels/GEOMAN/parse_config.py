...
from UrbanModels.GEOMAN.logger import setup_logging
from UrbanModels.GEOMAN.utils import read_json, write_json
...
class ConfigParser:
    def __init__(self, args, options='', timestamp=True):
        ...
        args.device = 0
        args.resume = None
        args.config = './UrbanModels/GEOMAN/config.json'
