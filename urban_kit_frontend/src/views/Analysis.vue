<template>
  <el-container class="is-vertical full-height">
              ...
              <el-collapse accordion class="full-height">
                ...
                <el-collapse-item>
                  ...
                  <ul class="advanced-func">
                    <li>
                      <el-button type="text" @click="interpolation_visible = true">Model Training</el-button>
                    </li>
                    <li>
                      <el-button type="text" @click="prediction_visible = true">Multi-Task Series Prediction</el-button>
                    </li>
                    <li>
                      <el-button type="text" @click="detection_visible = true">Single-Task Series Prediction</el-button>
                    </li>
                    <!--
                    <li>
    ...
    <!--Interpolation Modal-->
    <el-dialog title="Model Training" :visible.sync="interpolation_visible" width="80%" center class="my_dialog">
      <div :style="getDialogStyle">
        <Interpolation :time_step="child_time_step" :attribute="map_attribute"></Interpolation>
      </div>
    </el-dialog>
    <!--TS Prediction Modal-->
    <el-dialog title="Multi-Task Series Prediction" :visible.sync="prediction_visible" width="80%" center>
      <div :style="getDialogStyle">
        <TimeSeriesPredict></TimeSeriesPredict>
      </div>
    </el-dialog>
    <!--Anomaly Detection Modal-->
    <el-dialog title="Single-Task Series Detection" :visible.sync="detection_visible" width="80%" center>
      <div :style="getDialogStyle">
        <TimeSeriesPredict2></TimeSeriesPredict2>
      </div>
    </el-dialog>
    <!--Heat Map Modal-->
...
import TimeSeriesPredict2 from '@/components/TimeSeriesPredict2';
